...
const Bancos = () => {
    return (
        <div>
            <h1 className="text-center mt-8 mb-4 font-extrabold text-2xl text-[#181861]">Cambia al instante con todos los bancos en Perú</h1>
            <div>
                <div className="md:flex justify-center" >
                    ...
                    <div className="rounded-xl  border-2 mx-2 flex flex-col mt-2 p-2 ">
                        <div className="md:flex justify-center space-x-4">
                            <div className=" flex justify-center flex-col">
                                <span className="font-extrabold text-center text-[#181861] text-xl">15 min.</span>
