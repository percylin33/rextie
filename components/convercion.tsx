    ...
    return (
        <div className=" xl:w-[50%]">
            <div className="flex justify-center xl:justify-end">
                <div className='bg-[#4f5672] md:bg-opacity-80 rounded-3xl mx-2 mb-2 md:mx-8  pb-1 md:p-3 md:w-[75%]  max-w-[850px]'>
                    ...
                    <div className='bg-white m-2 rounded-xl p-4'>
                        <div className='flex justify-between mx-1 bg-[#eff2ff] rounded-xl p-1 md:my-3'>
                            <p
